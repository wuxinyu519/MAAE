...
UNIQUE_RUN_ID = 'unsupervised_3d_maae_lam_gaussian_posterior_dense_15z'
...
experiment_dir = output_dir / 'unsupervised_3d_maae_lam_gaussian_posterior_dense_15z'
...
def train_step(batch_x):
    ...
    with tf.GradientTape(persistent=True) as dc_tape:
        ...
        # z_id_ = np.random.randint(0, n_labels, size=[batch_x.shape[0]])
        # real_distribution = gaussian_mixture(batch_x.shape[0], n_labels=n_labels, n_dim=z_dim, label_indices=z_id_)
