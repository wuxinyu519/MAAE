...
if __name__ == '__main__':
    ...
    model_dec_1 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_mean_gaussian_posterior_dense_8z/decoder_199.model/")
    model_enc_1 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_mean_gaussian_posterior_dense_8z/encoder_199.model/")
    model_dis_1 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_mean_gaussian_posterior_dense_8z/discriminator0_199"
        ".model/")
    model_dis_2 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_mean_gaussian_posterior_dense_8z/discriminator1_199"
        ".model/")
    model_dis_3 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_mean_gaussian_posterior_dense_8z/discriminator2_199"
        ".model/")
    ...
    #model2
    model_3dis = []
    model_dec_2 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_max_gaussian_posterior_dense_8z/decoder_199.model/")
    model_enc_2 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_max_gaussian_posterior_dense_8z/encoder_199.model/")
    model_dis_1 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_max_gaussian_posterior_dense_8z/discriminator0_199"
        ".model/")
    model_dis_2 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_max_gaussian_posterior_dense_8z/discriminator1_199"
        ".model/")
    model_dis_3 = tf.keras.models.load_model(
        "./unsupervised_3d_maae_max_gaussian_posterior_dense_8z/discriminator2_199"
        ".model/")
